...
module.exports = {
    ...
    addTradingPackage: async (req, res) => {
        ...
        try {
            ...
            console.log('Checking for referrer, refer_id:', user.refer_id);
            ...
            if (user.refer_id) {
                ...
                if (referrer) {
                    ...
                    console.log('Referral bonus structure:', plan.referral_bonus);

                    const bonusThresholds = Object.keys(plan.referral_bonus)
                        .map(Number)
                        .sort((a, b) => a - b);

                    console.log('Referral bonus thresholds:', bonusThresholds);
                    ...
                    console.log('Applicable referral threshold:', applicableThreshold);

                    if (applicableThreshold > 0) {
                        const referralBonus = plan.referral_bonus[applicableThreshold];
                        console.log('Referral bonus amount:', referralBonus);
